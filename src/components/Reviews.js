...
export default function Reviews() {
  ...
  return (
    <div className=" flex justify-center items-center h-screen bg-black text-white md:h-80v">
      <div className="show-on-scroll flex flex-col justify-center items-center text-center w-[80%] h-4/5 gap-y-4">
        ...
        <div className="flex flex-col justify-center items-center h-full gap-y-4 md:flex-row ">
          <div className="bg-review bg-cover bg-center bg-no-repeat w-full h-1/3 flex flex-row justify-around items-center space-y-2 border-white border-2 rounded-md md:w-1/3 m-3 md:h-full md:flex-col md:justify-center">
            <div>
              <img alt="quotes" src="/quotes.svg" />
            </div>
            <div className="w-2/3 text-sm italic md:text-base lg:text-lg">
          ...
          <div className="bg-review bg-cover bg-center bg-no-repeat w-full h-1/3 flex flex-row  justify-around items-center space-y-2  border-white border-2 rounded-md md:w-1/3 m-3 md:h-full md:flex-col md:justify-center">
            ...
            <div className="w-2/3 text-sm italic md:text-base lg:text-lg">
              ...
              was great. - <span className="font-bold">Isaac Jones</span>
            </div>
          </div>
          <div className="bg-review bg-cover bg-center bg-no-repeat w-full h-1/3 flex flex-row justify-around items-center space-y-2  border-white border-2 rounded-md md:w-1/3 m-3 md:h-full md:flex-col md:justify-center">
            <div>
